...
const projects = [
  {
    name: 'Let\'s Shop TT',
    description:
      'Enabling customers to conveniently access local shops, restaurants, groceries, and pharmacies from their device.',
    link: { href: 'https://letsshoptt.com', label: 'letsshoptt.com' },
    logo: logoLetsShopTT,
  },
  {
    name: 'IslandFixx',
    description:
      'A service marketplace and one-stop solution platform.',
    link: { href: 'https://islandfixx.com', label: 'islandfixx.com' },
    logo: logoIslandFixx,
  },
  // {
  //   name: 'HelioStream',
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Jordan Bain</title>
        <meta
          name="description"
